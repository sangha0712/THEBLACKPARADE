...
const CharacterList: React.FC<CharacterListProps> = ({ onBack }) => {
    ...
    return (
        <div className="relative z-10 w-[95%] max-w-[1200px] bg-[#0a0a0a] border border-[#333] p-8 text-left shadow-[0_0_30px_rgba(0,0,0,0.9)] animate-[fadeIn_1s_forwards]">
            {/* Header with Disconnect Button */}
            <div className="relative mb-8 pb-4 border-b border-[#333] flex flex-col md:flex-row justify-center items-center gap-4">
                ...
                <button 
                    onClick={onBack}
                    className="md:absolute md:right-0 bg-[#0f0f0f] border border-red-800 text-red-600 px-6 py-2 hover:bg-red-600 hover:text-black transition-all duration-300 font-mono text-sm font-bold tracking-wider shadow-[0_0_10px_rgba(255,0,0,0.2)] hover:shadow-[0_0_20px_rgba(255,0,0,0.6)]"
                >
                    [ DISCONNECT ]
                </button>
            </div>
                    ...
                    >
                        ...
                        <div className="w-full h-64 bg-black overflow-hidden relative border-b border-[#222] group-hover:border-red-500/50 transition-colors">
                            ...
                            {char.image ? (
                                ...
                                <div className="w-full h-full flex items-center justify-center text-[#333] font-mono text-4xl">
                                    NO IMAGE
                                </div>
                            )}
                            {/* Tech overlay lines */}
            ...
            <div className="flex justify-between items-center mt-8 pt-4 border-t border-[#333] text-xs text-[#555] font-mono">
